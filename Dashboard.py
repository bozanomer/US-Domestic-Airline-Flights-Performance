...
# Add computation to callback function and return graph3lk43:
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            bar_fig = px.bar(bar_data, x='Quarter', y='Flights', color='CancellationCode', title='Monthly Flight Cancellation')

            # TODO5: Average flight time by reporting airline
            # TODO5: Average flight time by reporting airline
        #line_fig = px.line(line_data, x='Month', y='AirTime', color='Reporting_Airline', title='Average monthly flight time (minutes) by airline')`

            line_fig = px.line(line_data, x='Quarter', y='AirTime', color='Reporting_Airline', title='Average monthly flight time (minutes) by airline')
            ...
            carrier_fig = px.line(avg_car, x='Quarter', y='CarrierDelay', color='Reporting_Airline', title='Average carrrier delay time (minutes) by airline')
